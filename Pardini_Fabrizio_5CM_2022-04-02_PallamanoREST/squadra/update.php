...
if(
    ...
    if($squadra->update()){
        ...
        echo json_encode(array("message" => "Squadra aggiornata correttamente."));
    }
    else{
        //503 servizio non disponibile
        http_response_code(503);
        echo json_encode(array("message" => "Impossibile aggiornare la squadra."));
    }
}
else{
    //400 bad request
    http_response_code(400);
    echo json_encode(array("message" => "Impossibile aggiornare la squadra, i dati sono incompleti."));
}
