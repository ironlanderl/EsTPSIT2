...
public class start {
    public static void main(String[] args) {
        ...
        Atleta atleta = new Atleta("12345678901", "Mario", "Rossi", "123", new Date(1980, 1, 1));
        // creo un oggetto di tipo Squadra
        Squadra squadra = new Squadra("Juventus", "Milano");
        // creo un oggetto di tipo Contratto
        Contratto contratto = new Contratto(1, atleta, squadra, new Date(2018, 1, 1), new Date(2019, 1, 1));
